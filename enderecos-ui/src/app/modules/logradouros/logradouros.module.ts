...
import { LogradourosModalNomeComponent } from './logradouros-modal-nome/logradouros-modal-nome.component';

@NgModule({
  declarations: [LogradourosCadastroComponent, LogradourosPesquisaComponent, LogradourosModalNomeComponent],
  imports: [
    SharedModule,
    IMaskModule,
    CalendarModule,
