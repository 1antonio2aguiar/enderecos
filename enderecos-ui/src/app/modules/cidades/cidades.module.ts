...
import { CidadesModalListComponent } from './cidades-modal-list/cidades-modal-list.component';


@NgModule({
declarations: [CidadesCadastroComponent, CidadesPesquisaComponent, CidadesModalComponent, CidadesModalListComponent],
imports: [
	SharedModule,
  IMaskModule,
  CalendarModule,
