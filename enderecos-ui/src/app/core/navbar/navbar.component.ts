    ...
    this.items = [
      {
        ...
        items: [
					...
					{label: 'Distritos', routerLink: 'distritos', command: (event) => {this.display = false; } },
					...
					{label: 'TitulosPatentes', routerLink: 'titulos-patentes', command: (event) => {this.display = false; } },
					{label: 'TiposLogradouros', routerLink: 'tipos-logradouros', command: (event) => {this.display = false; } },
					{label: 'TiposEnderecos', routerLink: 'tipos-enderecos', command: (event) => {this.display = false; } },
					{label: 'Paises', routerLink: 'paises', command: (event) => {this.display = false; } },
        ]
      },
      {
        label: 'Atividades',
